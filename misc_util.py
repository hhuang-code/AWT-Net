# These helper functions are referred from:
# https://github.com/mutianxu/GDANet/blob/main/util/util.py
# and https://github.com/WangYueFt/dgcnn/blob/master/pytorch/util.py
...
def cal_loss(pred, gold, smoothing=True):
    ...
    gold = gold.contiguous().view(-1)   # ground-truth
